    ...
    <div class="fixed inset-[0] flex justify-center items-center">
        <form @submit.prevent="addNote" class="bg-white p-5 rounded shadow-lg">
            <div class="flex justify-between mb-3">
                <h1 class="text-xl">{{isUpdate ? "Update" : "Add"}} Note</h1>
            ...
            <div class="flex flex-col my-2">
                ...
                <textarea v-model.trim="note.content" placeholder="Content.." class="border rounded p-2 resize-none" rows="4" cols="50"></textarea>
            </div>
